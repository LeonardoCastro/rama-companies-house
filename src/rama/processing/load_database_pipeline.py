...
def process_database(arr_psc, arr_companies, string_ownership="ownership-of-shares"):
...
def get_secondlink(psc, companies, small_firstlink):
...
def get_edge_list(small_firstlink, psc_companies, sspsc):
